 ...
 * @since 0.1
 */
@BuiltInFunction(name= UuidGenFunction.NAME, args= {} )
public class UuidGenFunction extends ScalarFunction {
    public static final String NAME = "UUID_GEN";

    public UuidGenFunction() {
    }

    public UuidGenFunction(List<Expression> children) throws SQLException {
        super(children);
    }
